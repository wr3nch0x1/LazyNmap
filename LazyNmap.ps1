...
$nmapdir = Read-Host -Prompt '[+] Please enter Nmap installed Location [ Type S to skip and use (Default: C:\Program Files (x86)\Nmap\nmap.exe)]'
...
$arg1 = New-ScheduledTaskAction -Execute $nmapdir -Argument $Nmaparg 
